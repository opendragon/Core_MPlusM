\ProvidesFile{MMoverview.tex}[v1.0.0]
...
There is a unique service, the \serviceNameR[Registry~Service]{RegistryService}, that
maintains information on all the active services that are accessible to clients within an
\mplusm{} installation.
The primary utility is the \utilityNameR[Channel~Manager]{ChannelManager} application,
...
\serviceNameR[Registry~Service]{RegistryService}, have one or more additional \yarp{}
network connections that have no special properties and \inputOutput{} services have one
...
\objDiagram{MMmpmDiagram.ps}{mpmDiagram}{\mplusm{} structure}
\primaryEnd{}
