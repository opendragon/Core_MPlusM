...
\objScaledPicture{images/Installer01.eps}{0.75}
...
\objScaledPicture{images/Installer02.eps}{0.75}
...
\objScaledPicture{images/Installer03.eps}{0.75}
...
\objScaledPicture{images/Installer04.eps}{0.75}
\newpage
...
\objScaledPicture{images/Installer05.eps}{0.75}
...
appear.
\objScaledPicture{images/Installer05a.eps}{0.75}
...
\objScaledPicture{images/Installer06.eps}{0.75}
...
\objScaledPicture{images/Installer06a.eps}{0.75}
\newpage
...
\objScaledPicture{images/Installer06b.eps}{0.75}
...
\objScaledPicture{images/Installer07.eps}{0.75}
...
\objScaledPicture{images/Installer08.eps}{0.75}
...
registered admin's iMac.\fUS{}yarpns.\fUS{}tcp.local.
\outputEnd{}
...
of \asCode{mpmRegistryService} that is running and `\asCode{admin's~iMac}' will be
...
\outputEnd{}
where `\asBoldCode{63918}' will be the process identifier of the already--running copy of
...
\emph{Channel Manager} application, which was placed in the \asCode{/Applications}
directory.
You should see something similar to the following:
\objScaledPicture{images/RunningChannelManager.eps}{0.75}
...
\objScaledPicture{images/win_install01.eps}{0.75}
Click the \asBoldCode{I~Agree} button to proceed.
\objScaledPicture{images/win_install02.eps}{0.75}
\newpage
Then, select the destination for the installed files:
\objScaledPicture{images/win_install03.eps}{0.75}
...
\objScaledPicture{images/win_install04.eps}{0.75}
\newpage
...
\objScaledPicture{images/win_install05.eps}{0.75}
The \mplusm{} Library makes use of the Apple Bonjour SDK, and the installer will be
launched at this point:
\objScaledPicture{images/win_install06.eps}{0.75}
\newpage
Proceed with the installation of the Bonjour SDK:
\objScaledPicture{images/win_install07.eps}{0.75}


\objScaledPicture{images/win_install08.eps}{0.75}
\newpage

\objScaledPicture{images/win_install09.eps}{0.75}


\objScaledPicture{images/win_install10.eps}{0.75}
\newpage
This finalizes the installation process:
\objScaledPicture{images/win_install11.eps}{0.75}
\newpage
...
\objScaledPicture{images/win_run01.eps}{0.75}
Please click on the \asBoldCode{Allow access} button to enable the networking features of
each application.
\tertiaryEnd{}
\secondaryEnd{}
\secondaryStart{Linux}
\TBD{}
\tertiaryStart{Testing~The~Linux~Installation}
\TBD{}
\tertiaryEnd{}
\secondaryEnd{}
\primaryEnd{}
