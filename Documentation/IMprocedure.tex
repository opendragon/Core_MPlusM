...
For the most part, testing the Windows installation is similar to the Mac version, except most of the applications can be executed directly by double clicking the icons in the /bin folder of the installation directory. If command-line arguments are required (e.g. for clearing of the yarp conf file), it can be done by opening a Windows ``command prompt'' and \asBoldCode{cd}ing into the /bin folder.
...
Please click on \asBoldCode{Allow access} to enable the networking features of each application.
