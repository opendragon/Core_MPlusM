...
After obtaining the \asCode{M+M.pkg} file, open it by double\longDash{}clicking, at which
point the \asEmphCode{Introduction} page is presented.
\objScaledPicture{images/Installer01}{0.75}
...
\objScaledPicture{images/Installer02}{0.75}
...
\objScaledPicture{images/Installer03}{0.75}
...
\objScaledPicture{images/Installer04}{0.75}
\newpage
...
\objScaledPicture{images/Installer05}{0.75}
...
appear.
\objScaledPicture{images/Installer05a}{0.75}
...
\objScaledPicture{images/Installer06}{0.75}
...
\objScaledPicture{images/Installer06a}{0.75}
\newpage
...
\objScaledPicture{images/Installer06b}{0.75}
...
\objScaledPicture{images/Installer07}{0.75}
...
\objScaledPicture{images/Installer08}{0.75}
...
\objScaledPicture{images/RunningChannelManager}{0.75}
...
\objScaledPicture{images/win_install01}{0.75}
Click the \asBoldCode{I~Agree} button to proceed.
\objScaledPicture{images/win_install02}{0.75}
\newpage
Then, select the destination for the installed files:
\objScaledPicture{images/win_install03}{0.75}
...
\objScaledPicture{images/win_install04}{0.75}
\newpage
...
\objScaledPicture{images/win_install05}{0.75}
The \mplusm{} Library makes use of the Apple Bonjour SDK, and the installer will be
launched at this point:
\objScaledPicture{images/win_install06}{0.75}
\newpage
Proceed with the installation of the Bonjour SDK:
\objScaledPicture{images/win_install07}{0.75}


\objScaledPicture{images/win_install08}{0.75}
\newpage

\objScaledPicture{images/win_install09}{0.75}


\objScaledPicture{images/win_install10}{0.75}
\newpage
This finalizes the installation process:
\objScaledPicture{images/win_install11}{0.75}
\newpage
...
\objScaledPicture{images/win_run01}{0.75}
