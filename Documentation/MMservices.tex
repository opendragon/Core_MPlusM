...
primarily for use by the \emph{\CMU} application}
...
the \serviceNameX[\RS]{RegistryService} has successfully started:
...
It is used by the \emph{\CMU} to record the actual arguments used to launch the executable
...
It is used by the \utilityNameR{mpmServiceLister} and \emph{\CMU} applications to
...
It is used by the \serviceNameR[\RS]{RegistryService} and the
\utilityNameR{mpmServiceLister} and \emph{\CMU} applications to collect basic information
about each service.
...
\utilityNameR{mpmServiceLister} and \emph{\CMU} applications to identify services in order
