...
It is used by the \utilityNameR{m+mServiceLister} and \emph{\CMU} applications to
...
It is used by the \serviceNameR[\RS]{RegistryService} and the
\utilityNameR{m+mServiceLister} and \emph{\CMU} applications to collect basic information
about each service.
...
\utilityNameR{m+mServiceLister} and \emph{\CMU} applications to identify services in order
