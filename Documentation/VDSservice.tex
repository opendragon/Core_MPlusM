...
\begin{itemize}
\item \textbf{-h:} specifies the host name of the Vicon DataStream server
\item \textbf{-p:} specifies the port on the Vicon DataStream server to connect to, which
is usually \asCode{801}
