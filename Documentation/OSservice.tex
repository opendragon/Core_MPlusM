...
The \asCode{mpmOpenStageInputService} application is an Input service,
...
{launchServiceOpenStage}{Launch options for the \OSI{} service}{0.8}
...
{serviceRunningOpenStage}{The \emph{Channel Manager} entity for the \OSI{} service}%
{1.0}
\secondaryEnd
\primaryEnd{}
