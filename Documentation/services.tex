...
The \requestsNameX{Service~Registry}{ServiceRegistry}{match} request
...
The \requestsNameX{Service~Registry}{ServiceRegistry}{ping} request
...
The \requestsNameX{Service~Registry}{ServiceRegistry}{register} request
...
The \requestsNameX{Service~Registry}{ServiceRegistry}{unregister} request
