...
%{serviceRunningKinectVTwoBlob}{The \emph{Channel Manager} entity for the \KVtwoBI{} service}{1.0}
...
%{configureServiceKinectVTwoBlob}{Configuration window for the \emph{\KVtwoBI} service}{1.0}
\secondaryEnd
\primaryEnd{}
