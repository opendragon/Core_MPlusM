...
\item \cmdItem{b}{start the processing thread and the input and output streams}
\item \cmdItem{c}{configure the service; this has no effect, as the service has no
configurable parameters}
\item \cmdItem{e}{stop the processing thread and input and output streams}
\item \cmdItem{q}{quit the application}
\item \cmdItem{r}{restart the processing thread and input and output streams}
\item \cmdItem{u}{reset the configuration so that it will be reprocessed when the
