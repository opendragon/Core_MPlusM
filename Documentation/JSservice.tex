...
{launchServiceJavaScript}{Launch options for the \JSIO{} service}{0.8}
...
{javaScriptWithTag}{The \emph{Channel Manager} entity for the \JSIO{} service with a tag}%
{1.0}
...
\emph{Channel Manager} application, the additional text entry fields cannot be removed
from the dialog, once added.\closeSq{}
\secondaryEnd
\primaryEnd{}
