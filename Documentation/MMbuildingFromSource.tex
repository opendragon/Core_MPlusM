...
\item\exSp\asCode{make~clean~\&\&~make}
\item\exSp\asCode{sudo~make~install}
\item\exSp\asCode{sudo cp dist/lib/libmozglue.dylib /opt/M+M/spidermonkey/lib}
\item\exSp\asCode{sudo install\fUS{}name\fUS{}tool -change
"@executable\fUS{}path/libmozglue.dylib" \textbackslash\\
"@rpath/libmozglue.dylib" /opt/M+M/spidermonkey/libmozjs-.dylib}
\end{itemize}
...
\item\exSp\asCode{mkdir~\fUS{}obj\fUS}
\item\exSp\asCode{cd~\fUS{}obj\fUS}
\item\exSp\asCode{../configure {-}{-}enable-release {-}{-}enable-more-deterministic
{-}{-}enable-build-nspr \textbackslash\\
{-}{-}prefix="\textbackslash{}"/c/Program Files (x86)/M+M/spidermonkey\textbackslash{}""}
\item\exSp\asCode{mozmake}
\item\exSp\asCode{mozmake install}
\item\exSp\asCode{exit}
%\item\exSp\asCode{mkdir \textbf{devel}/javascript}
%\item\exSp\asCode{mkdir \textbf{devel}/javascript/bin}
%\item\exSp\asCode{mkdir \textbf{devel}/javascript/include}
%\item\exSp\asCode{mkdir \textbf{devel}/javascript/lib}
%\item\exSp\asCode{mkdir \textbf{devel}/javascript/nspr-include}
%\item\exSp\asCode{cd dist}
%\item\exSp\asCode{cp bin/*.dll \textbf{devel}/javascript/bin}
%\item\exSp\asCode{cp lib/* \textbf{devel}/javascript/lib}
%\item\exSp\asCode{cp -R include/* \textbf{devel}/javascript/include}
%\item\exSp\asCode{cp -R nspr-include/* \textbf{devel}/javascript/nspr-include}
\end{itemize}
