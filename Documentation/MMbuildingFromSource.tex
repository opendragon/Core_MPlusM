...
\item Execute the command `\asCode{make~clean}'
...
\item Open the directory `\asCode{Utilities\fatUnderscore{}ChannelManager-master}' within
\asCode{MPM}
...
\item `\asCode{Product $\Rightarrow$ Build}' or `\asCode{Product $\Rightarrow$ Run}' the
project
