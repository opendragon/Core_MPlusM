...
\textbar{} \makebox[5.5em][l]{\textbf{{-}{-}#3} \textit{#2}} #4}
%END LATEX
...
\newcommand{\insertAppParameters}{The application has nine optional parameters:
\begin{itemize}
\item\optItem{a}{}{autostart}{indicates that the service is to be started immediately}
...
leave}
\item\exSp\optItem{i}{}{info}{display the type of the executable and the valid options and
leave}
...
\newcommand{\insertAutoAppParameters}{The application has eight optional parameters:
\begin{itemize}
...
installation can support multiple copies of the #1 service, but the \emph{Channel Manager}
