...
%HEVEA\textbf{->}
%BEGIN LATEX
\thinspace\boldmath{$\vdash$}\thinspace
%END LATEX
}
\newcommand{\pseudotwotabs}{%
%HEVEA\textbf{-> ->}
%BEGIN LATEX
\thinspace\boldmath{$\vdash$}\thinspace\boldmath{$\vdash$}\thinspace
%END LATEX
}
...
%HEVEA\textbf{#1} #2%
%BEGIN LATEX
\makebox[1em][l]{\textbf{#1}} #2
%END LATEX
}
\newcommand{\optItem}[3]{%
%HEVEA\textbf{-#1} | \textbf{--#2} #3%
%BEGIN LATEX
\makebox[1.25em][l]{\textbf{--#1}} \textbar{} \makebox[5em][l]{\textbf{{-}{-}#2}} #3
%END LATEX
}
...
\newcommand*{\objImage}[1]{%
%HEVEA\imgsrc{#1.png}%
%BEGIN LATEX
\includegraphics{#1.eps}
%END LATEX
}
\newcommand*{\objScaledImage}[2]{%
%HEVEA\imgsrc[scale=#1]{#2.png}%
%BEGIN LATEX
\includegraphics[scale=#1]{#2.eps}
%END LATEX
}
\newcommand*{\objImageWithWidth}[2]{%
%HEVEA\imgsrc[width=#1]{#2.png}%
%BEGIN LATEX
\includegraphics[width=#1]{#2.eps}
%END LATEX
}
\newcommand{\mpmLogo}{%
%HEVEA\objScaledImage{0.5}{images/m+m_tight_logo}%
%BEGIN LATEX
\objImageWithWidth{5em}{images/m+m_tight_logo}
%END LATEX
}
