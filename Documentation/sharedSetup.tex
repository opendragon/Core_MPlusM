...
%HEVEA\newcommand{\pseudotab}{\textbf{->}}%
%BEGIN LATEX
\newcommand{\pseudotab}{\thinspace\boldmath{$\vdash$}\thinspace}
%END LATEX

%HEVEA\newcommand{\pseudotwotabs}{\textbf{-> ->}}%
%BEGIN LATEX
...
%HEVEA\newcommand{\tabSymbol}{\texttt{\textbf{->}}}%
%BEGIN LATEX
...
% Create a framed box as a figure, centred horizontally (note that we can't use
% \textttt{}, as the third argument could be quite large):
%\newcommand{\objFileDescription}[4][0.75]{\begin{figure}[!ht]%
%\setlength{\fboxsep}{3pt}\setlength{\fboxrule}{0.75bp}%
%\centering\parbox[t]{#1\textwidth}{\begin{flushleft}\footnotesize\ttfamily #4%
%\end{flushleft}}\caption{#2\ }\label{file:#3}\end{figure}}
...
%HEVEA\newcommand{\mpmLogo}{\objImageWithWidth{150}{images/m+m_tight_logo}}%
%BEGIN LATEX
\newcommand{\mpmLogo}{\objImageWithWidth{5em}{images/m+m_tight_logo}}
%END LATEX
