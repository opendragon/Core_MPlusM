...
\newcommand{\insertAppParameters}{The application has seven optional parameters:
\begin{itemize}
...
\newcommand{\insertAutoAppParameters}{The application has six optional parameters:
\begin{itemize}
