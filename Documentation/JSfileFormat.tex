...
\asCode{scriptInlets} value\exSp{} is retrieved (or the \asCode{scriptInlets}() function
is executed to get a value)
...
\asCode{scriptInterval} value\exSp{} is retrieved (or the \asCode{scriptInterval}()
