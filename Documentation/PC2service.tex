\ProvidesFile{PC2service.tex}[v1.0.0]
\primaryStart[ThePCtwoI2Service]{The~\PCtwoI{}~Service}
The \asCode{mpmProComp2InputService} application is an Input service,
...
{launchServiceProCompTwo}{Launch options for the \PCtwoI{} service}{0.8}
