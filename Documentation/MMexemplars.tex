...
\examplesNameR{Services}{mpmTruncateFloatFilterService} example application.
...
\examplesNameR{Services}{mpmRandomBurstInputService} example application.
...
\examplesNameR{Services}{mpmRecordIntegersOutputService} example application.
