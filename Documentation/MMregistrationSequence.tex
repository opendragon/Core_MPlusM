...
A \requestsNameR{RegistryService}{Registry~Service}{register} or
\requestsNameR{RegistryService}{Registry~Service}{ping} request sent to the
\serviceNameR[Registry~Service]{RegistryService} triggers the following sequence of
...
\end{enumerate}
The \serviceNameR[Registry~Service]{RegistryService} plays the r\^ole of a client of the
service that sent the original \requestsNameR{RegistryService}{Registry~Service}{register}
or \requestsNameR{RegistryService}{Registry~Service}{ping} request, in order to obtain the
...
\requestsNameR{RegistryService}{Registry~Service}{associate} requests to the
\serviceNameR[Registry~Service]{RegistryService}.\\

Note that a \requestsNameR{RegistryService}{Registry~Service}{ping} request will not
send \requestsNameR{Basic}{Basic}{name} or \requestsNameR{Basic}{Basic}{list} to the
\serviceNameR[Registry~Service]{RegistryService} if the requesting service is recognized
