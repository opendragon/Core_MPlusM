...
A \requestsNameR{Registry~Service}{RegistryService}{register} or
\requestsNameR{Registry~Service}{RegistryService}{ping} request sent to the
...
service that sent the original \requestsNameR{Registry~Service}{RegistryService}{register}
or \requestsNameR{Registry~Service}{RegistryService}{ping} request, in order to obtain the
...
\requestsNameR{Registry~Service}{RegistryService}{associate} requests to the
\serviceNameR[Registry~Service]{RegistryService}.\\

Note that a \requestsNameR{Registry~Service}{RegistryService}{ping} request will not
