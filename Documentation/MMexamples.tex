...
[\examplesNameR{Services}{mpmRandomBurstInputService}], three output services
[\examplesNameR{Services}{mpmAbsorberOutputService},
\examplesNameR{Services}{mpmRecordAsJSONOutputService} and\\
\examplesNameR{Services}{mpmRecordIntegersOutputService}] and a filter service
[\examplesNameR{Services}{mpmTruncateFloatFilterService}].\\
...
interaction.
\tertiaryStart{\examplesNameP{Services}{mpmAbsorberOutputService}}
The \examplesNameX{Services}{mpmAbsorberOutputService} application is an Output
...
{launchServiceAbsorber}{Launch options for the Absorber output service}{0.8}
...
service}{1.0}
\tertiaryEnd{\examplesNameE{Services}{mpmAbsorberOutputService}}
\condPage
...
{launchServiceEcho}{Launch options for the Echo service}{0.8}
...
\tertiaryStart{\examplesNameP{Services}{mpmRandomBurstInputService}}
The \examplesNameX{Services}{mpmRandomBurstInputService} application is an Input service,
...
{launchServiceRandomBurst}{Launch options for the Random Burst input service}{0.8}
...
service}{1.0}
\tertiaryEnd{\examplesNameE{Services}{mpmRandomBurstInputService}}
\condPage
...
{launchServiceRandomNumber}{Launch options for the Random Number service}{0.8}
...
\condPage
\tertiaryStart{\examplesNameP{Services}{mpmRecordAsJSONOutputService}}
The \examplesNameX{Services}{mpmRecordAsJSONOutputService} application is an Output
...
{launchServiceRecordAsJSON}{Launch options for the Record As JSON output service}{0.8}
...
{recordJSONWithTag}{The \emph{Channel Manager} entity for the Record As JSON output
...
{recordJSONWithEndpoint}{The \emph{Channel Manager} entity for the Record As JSON output
...
{recordJSONWithEndpointAndTag}{The \emph{Channel Manager} entity for the Record As JSON
output service with an endpoint and tag}{1.0}
\tertiaryEnd{\examplesNameE{Services}{mpmRecordAsJSONOutputService}}
\condPage
\tertiaryStart{\examplesNameP{Services}{mpmRecordIntegersOutputService}}
The \examplesNameX{Services}{mpmRecordIntegersOutputService} application is an Output
...
{launchServiceRecordIntegers}{Launch options for the Record Integers output service}{0.8}
...
{recordIntegersWithTag}{The \emph{Channel Manager} entity for the Record Integers output
service with a tag}{1.0}

If an `endpoint' value is specified, the output file name forms part of the title bar but
does not affect the channel names:
\objScaledDiagram{mpm_images/recordIntegersWithEndpoint}%
{recordIntegersWithEndpoint}{The \emph{Channel Manager} entity for the Record Integers
output service with an endpoint}{1.0}

If both a `tag' value and an `endpoint' value are provided, the `endpoint' value
determines the channel names while the `tag' value is combined with the output file name
as part of the title bar:
\objScaledDiagram{mpm_images/recordIntegersWithEndpointAndTag}%
{recordIntegersWithEndpointAndTag}{The \emph{Channel Manager} entity for the Record
Integers output service with an endpoint and tag}{1.0}
\tertiaryEnd{\examplesNameE{Services}{mpmRecordIntegersOutputService}}
\condPage
...
{launchServiceRunningSum}{Launch options for the Running Sum service}{0.8}
...
\tertiaryStart{\examplesNameP{Services}{mpmTruncateFloatFilterService}}
The \examplesNameX{Services}{mpmTruncateFloatFilterService} application is a Filter
...
{launchServiceTruncateFloat}{Launch options for the Truncate Float filter service}{0.8}
...
filter service}{1.0}
\tertiaryEnd{\examplesNameE{Services}{mpmTruncateFloatFilterService}}
\secondaryEnd
\condPage
...
If the adapter is selected for execution from within the \emph{Channel Manager}
application, the following dialog will be presented:
\objScaledDiagram{mpm_images/launchRandomNumberAdapter}%
{launchAdapterRandomNumber}{Launch options for the Random Number adapter}{0.8}
...
{launchAdapterRunningSum}{Launch options for the Running Sum adapter}{0.8}
\condPage{}
For details on the usage of the `endpoint' and `tag' options, see the \emph{Channel
Manager Utility} manual.
Once the options are set, the following image will appear in the \emph{Channel Manager}
...
{launchAdapterRunningSumAlt}{Launch options for the Running Sum alternate adapter}{0.8}
