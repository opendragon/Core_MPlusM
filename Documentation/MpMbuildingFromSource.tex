...
\MMMU{} application; the files needed to compile and link with OGDF are
...
\begin{itemize}
\item Make sure to update the date recorded in the last line of the \asCode{license.tex}
