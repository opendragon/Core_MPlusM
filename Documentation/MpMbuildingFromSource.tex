...
the Microsoft Windows SDK, it is currently not possible to build the Common Lisp Filter
service on Microsoft Windows, so there's no need to build \textbf{\ECL}.
\tertiaryEnd
\tertiaryStart{Building~on~Linux}
\begin{itemize}
\item\TBD
