...
\item\exSp{} Within \asCode{Visual Studio}, select the \asCode{Debug} :\ \asCode{Win32}
...
\item\exSp{} Select the \asCode{Release} :\ \asCode{Win32} configuration and clear out any
...
\item\exSp{} Edit the variable value to be
`\asCode{\textbf{devel}\textbackslash{}ACE\fUS{}wrappers2\textbackslash{}include}' and
...
setting is for \asCode{Visual Studio 12} and that `\asCode{Use default native compilers}'
is selected
...
Builds\textbackslash{}VisualStudio2013\textbackslash{}m+m manager.sln}' with
\asCode{Visual Studio}
\item\exSp{} Within \asCode{Visual Studio}, select the \asCode{Debug} configuration and
build it via the menu item `\asCode{Build \bigRightArrow{} Build Solution}'
\item\exSp{} Select the \asCode{Release} configuration and build it via the menu item
...
the menu item `\asCode{Build \bigRightArrow{} Project Only \bigRightArrow{} Build Only
INSTALL}'
\item\exSp{} Select the \asCode{PACKAGE} target and construct the distribution package via
the menu item `\asCode{Build \bigRightArrow{} Project Only \bigRightArrow{} Build Only
PACKAGE}'
\item\exSp{} The distribution package is the \asCode{m+m-\MMVn-win32.exe} file located in
the\\
\asCode{Core\fUS{}MPlusM\textbackslash\fUS{}CPack\fUS{}Packages\textbackslash{}win32%
\textbackslash{}NSIS} directory
\end{itemize}
\tertiaryEnd
