...
\primaryStart[TheCLService]{The~\CLIO{}~Service}
The \asCode{m+mCommonLispService} application is an \inputOutput{} service,
executing a set of \CL{} functions contained in a file.
...
{launchServiceJavaScript}{Launch options for the \emph{\CLIO} service}{0.8}
...
{serviceRunningJavaScript}{The \emph{\MMMU} entity for the \emph{\CLIO} service}{1.0}
...
{javaScriptWithTag}{The \emph{\MMMU} entity for the \emph{\CLIO} service with a tag}{1.0}
...
{javaScriptWithEndpoint}{The \emph{\MMMU} entity for the \emph{\CLIO} service with an
endpoint}{1.0}
...
{javaScriptWithEndpointAndTag}{The \emph{\MMMU} entity for the \emph{\CLIO} service with
