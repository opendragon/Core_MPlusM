...
The \asCode{m+mCommonLispService} application is a Filter service, executing a set of
\CL{} functions contained in a file.
...
\objScaledDiagram{mpm_images/runningCommonLispFilterService}%
