...
The \CLIO{} service loads a \CL{} file that contains a number of required and optional
values.
...
The \CLIO{} service provides the following standard classes as part of the \CL{}
environment:\\
...
The \CLIO{} service provides the following class as part of the \CL{} environment:
\tertiaryStart{Stream}
...
The \CLIO{} service provides the following functions as part of the \CL{} environment:
\begin{itemize}
...
The \CLIO{} service provides the following values as part of the \CL{} environment:
\begin{itemize}
\item\exSp\textbf{\asCode{argv}\openSq\closeSq} \longDash{} a list of the arguments passed
to the script
...
The \CLIO{} service requires that the following values are supplied by the \CL{} file:
\begin{itemize}
...
The \CLIO{} service will use the following values, if they are supplied by the \CL{} file:
\begin{itemize}
