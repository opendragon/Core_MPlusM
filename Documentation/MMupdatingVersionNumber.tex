...
number
\item\exSp{} The \emph{\CMU} version number is located in the \asCode{Xcode} project
settings \longDash{} make sure to change both of the \asCode{Version} and \asCode{Build}
settings in the \asCode{General} settings for the \asCode{\CMU} target \longDash{} and the
\asCode{CMResources.rc} file, where the `\asCode{FILEVERSION}', `\asCode{FileVersion}' and
`\asCode{ProductVersion}' values will need to be modified
