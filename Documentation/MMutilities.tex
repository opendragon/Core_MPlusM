...
`Display service metrics' menu item
...
{images/serviceMenuMetricsEnabled.eps}{serviceMenu}{Service menu}{0.7}
...
{serviceChannelMenu}{Primary channel menu}{0.7}
\clearpage
...
{regularChannelMenu}{Non--primary channel menu}{0.7}
\clearpage
