...
\utilityNameR{mpmTunnelClient} application.\\
...
\utilityNameX{mpmTunnelService} service, but the \emph{Channel Manager} application cannot
...
The \utilityNameX{mpmTunnelClient} application is a command--line tool to route a
non--\yarp{} network data source to a non--\yarp{} network data sink via the
\utilityNameR{mpmTunnelService} application.\\
