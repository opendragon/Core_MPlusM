...
The command--line tools all have three options:
\begin{itemize}
\item \textbf{--h} \textbar{} \textbf{{-}{-}help} display the list of optional parameters
and arguments and leave
\item \textbf{--j} \textbar{} \textbf{{-}{-}json} generate JSON--formatted output
\item \textbf{--t} \textbar{} \textbf{{-}{-}tabs} generate output in tab--delimited form
\end{itemize}
