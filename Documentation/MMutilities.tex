...
specific port.
Holding down the `Shift' key at the same time as the `Control' key results in more
detailed information: for services, the (non--default) requests for the service are also
displayed and, for ports of a service, the description of the protocol for the port is
displayed, if the protocol is non--blank.\\
...
used:
\outputBegin{}
/\textdollar{}ervice, /\serviceName/filter/truncatefloat, /blort
\outputEnd{}
or, if JSON--formatted output is requested:
\outputBegin{}
\openSq{} "/\textdollar{}ervice", "/\serviceName/filter/truncatefloat", "/blort" \closeSq
\outputEnd{}
of, if tab--delimited output is requested, with tabs shown as
`\texttt{\boldmath{$\vdash$}}':
\outputBegin{}
/\textdollar{}ervice\pseudotab/\serviceName/filter/truncatefloat\pseudotab/blort
\outputEnd{}
...
Operation:\ \openSq{}f q\closeSq{}?\ \textbf{f}\\
Match criteria:\ \textbf{tag!blurt}\\
\openSq{} "/\textdollar{}ervice", "/\serviceName/filter/truncatefloat", "/blort"
\closeSq{}\\
Operation:\ \openSq{}f q\closeSq{}?\ \textbf{f}\\
Match criteria:\ \textbf{tag:blurt}\\
