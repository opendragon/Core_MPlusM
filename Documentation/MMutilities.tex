...
\item \textbf{Display channel metrics} display information about the activity on the
channel -- the number of bytes and number of messages sent to and from the channel
\item \textbf{Add simple monitor} activate a monitor with a simple graphical
representation of the activity on the channel; this is currently not implemented
\item \textbf{Add scrolling monitor} activate a monitor displaying the actual messages on
the channel; this is currently not implemented
\end{itemize}
