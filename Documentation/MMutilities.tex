...
\tertiaryStart{\utilityNameP{mpmStopRegistry}}
The program \utilityNameX{mpmStopRegistry} tells the
\serviceNameR[Registry~Service]{RegistryService} to stop running.
\tertiaryEnd{\utilityNameE{mpmStopRegistry}}
