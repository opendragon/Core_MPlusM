...
\clearpage
\objScaledDiagram{mpm_images/dragAdd2}{dragAdd}{Adding a connection via drag}{0.8}
...
\end{itemize}
\objScaledDiagram{mpm_images/backgroundMenu}{backgroundMenu}{Background menu}{0.7}
...
entity
\end{itemize}
\objScaledDiagram{mpm_images/entityMenu}{entityMenu}{Entity menu}{0.7}
\clearpage
...
\end{itemize}
\objScaledDiagram{mpm_images/portMenu}{portMenu}{Regular port menu}{0.7}
