...
\end{itemize}
\objDoubleScaledDiagram{mpm_images/backgroundMenuNoHidden}%
...
background menu.\\
\objScaledDiagram{mpm_images/displayMenu}{displayMenu}{Display menu}{1.0}
\clearpage
...
\objScaledDiagram{mpm_images/operationMenu}{operationMenu}{Operation menu}{1.0}
