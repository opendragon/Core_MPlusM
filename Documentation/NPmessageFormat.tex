\ProvidesFile{NPmessageFormat.tex}[v1.0.0]
\primaryStart{The~Message~Format}
Each time that the NaturalPoint controller reports that there is information available,
the \asCode{NaturalPointInputService} packages it into a single message
