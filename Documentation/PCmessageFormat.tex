\ProvidesFile{PCmessageFormat.tex}[v1.0.0]
\primaryStart{The~Message~Format}
Each time that the ProComp controller reports that there is information available,
the \asCode{ProCompInputService} packages it into a single message
