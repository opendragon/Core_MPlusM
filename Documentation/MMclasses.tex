...
\secondaryStart{\classNameP{Common}{BaseAdapterData}}
...
\classNameR{Common}{BaseService} and instances of derived classes of
...
\secondaryStart{\classNameP{Common}{BaseClient}}
...
\secondaryStart{\classNameP{Common}{BaseContext}}
...
\secondaryStart{\classNameP{Common}{BaseFilterService}}
...
\secondaryStart{\classNameP{Common}{BaseInputHandler}}
...
\secondaryStart{\classNameP{Common}{BaseInputOutputService}}
...
\secondaryStart{\classNameP{Common}{BaseInputService}}
...
\secondaryStart{\classNameP{Common}{BaseMatcher}}
The \classNameX{Common}{BaseMatcher} class represents a `handle' to a top\longDash{}down
pattern matcher used by the \serviceNameR[Registry~Service]{RegistryService} to convert
the arguments of \requestsNameR{Registry~Service}{RegistryService}{match} requests into
...
\secondaryStart{\classNameP{Common}{BaseOutputService}}
...
\secondaryStart{\classNameP{Common}{BaseRequestHandler}}
...
\secondaryStart{\classNameP{Common}{BaseService}}
...
\secondaryStart{\classNameP{Common}{Endpoint}}
...
\secondaryStart{\classNameP{Common}{ServiceRequest}}
...
\secondaryStart{\classNameP{Common}{ServiceResponse}}
