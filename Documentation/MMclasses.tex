...
\requestsNameR{RegistryService}{Registry~Service}{match} request of the
...
inform the \serviceNameR[Registry~Service]{RegistryService} about their input and output
...
\requestsNameR{RegistryService}{Registry~Service}{match} requests into \asCode{SQL}
operations.
