...
const
{
    ...
    for (MatchConstraintListSize ii = 0, maxI = _constraints.size(); ii < maxI; ++ii)
    {
        MatchFieldWithValues * element = _constraints[ii];
...
const
{
    ...
    {
        result = _constraints[static_cast<MatchConstraintListSize>(index)];
    }
    else
    {
        result = NULL;
