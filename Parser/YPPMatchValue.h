...
namespace YarpPlusPlusParser
{
    ...
    public:
        ...
        /*! @brief Create a pattern matcher if the next substring would be a valid value.
         ...
         @param insideList @c true if we are scanning list elements and @c false if we are looking for singular values.
        ...
        /*! @brief The escape character this is used during conversion to SQL.
         @returns The character that SQL is to use as an escape character. */
        static char escapeCharacter(void);
