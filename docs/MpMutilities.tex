...
\condPage
\tertiaryStart{\utilityNameP{m+mPortList}}
The application \utilityNameX{m+mPortList} displays the active \yarp{} ports and
\mplusm{} entities.
...
\outputEnd{}
and the tab\longDash{}delimited output would be empty.
\tertiaryEnd{\utilityNameE{m+mPortList}}
...
Requests:
Path:              .../m+mRandomBurstInputService
...
Requests:
Path:              .../m+mTruncateFloatFilterService
...
for a service on the given channel", "Path": ".../m+mRegistryService",
...
"Requests": "", "Path": ".../m+mRandomBurstInputService", "SecondaryInputs": [ ],
...
".../m+mTruncateFloatFilterService", "SecondaryInputs": [ { "Name":
...
the\\
given channel\pseudotab\textellipsis{}/m+mRegistryService\pseudotwotabs{}/\dollarService%
...
\pseudotwotabs\\
\textellipsis{}/m+mRandomBurstInputService\pseudotwotabs{}/\serviceName/input/%
...
\textellipsis{}/m+mTruncateFloatFilterService\pseudotab{}/shorten/input\textbraceleft{}%
...
\outputBegin
\begin{verbatim}
m+m Version: 1.6.9, YARP Version: 2.3.62.1, ACE Version: 6.3.2
\end{verbatim}
\outputEnd{}
or, if \json\longDash{}formatted output is requested:
\outputBegin
\begin{verbatim}
{ "m+m": "1.6.9", "YARP": "2.3.62.1", "ACE": "6.3.2" }
\end{verbatim}
\outputEnd{}
or, if tab\longDash{}delimited output is requested, with tabs shown as `\tabSymbol':
\outputBegin{}
1.6.9\pseudotab{}2.3.62.1\pseudotab{}6.3.2
\outputEnd
