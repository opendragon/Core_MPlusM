...
\primaryStart[TheKV2BIservice]{The \KVtwoBI{} Service (\win{} only)}
The \asCode{m+mKinectV2BlobInputService} application is an Input service,
...
\condPage
\insertTagAndEndpointDescription{mpm_images/runningKinectV2BlobInputService}%
