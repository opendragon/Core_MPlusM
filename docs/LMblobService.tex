\ProvidesFile{LMblobService.tex}[v1.0.0]
...
The \emph{configure} request has a single argument \longDash{} a
...
\insertTagAndEndpointDescription{mpm_images/runningLeapBlobInputService}%
...
appear:
\objScaledDiagram{mpm_images/configureLeapBlobInputService}%
