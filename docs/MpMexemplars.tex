\ProvidesFile{MpMexemplars.tex}[v1.0.0]
...
\examplesNameR{Adapters}{m+mRandomNumberAdapter} example application.
...
\examplesNameR{Clients}{m+mRandomNumberClient} example application.
The files \asCode{M+MRandomNumberXXX.YYY} correspond to the files
...
\examplesNameR{Services}{m+mRandomNumberService} example application.
...
\examplesNameR{Services}{m+mTruncateFloatFilterService} example application.
The files \asCode{M+MTruncateFloatFilterXXX.YYY} correspond to the files
...
\examplesNameR{Services}{m+mRandomBurstInputService} example application.
The files \asCode{M+MRandomBurstInputXXX.YYY} correspond to the files
...
\examplesNameR{Services}{m+mRecordIntegersOutputService} example application.
The files \asCode{M+MRecordIntegersOutputXXX.YYY} correspond to the files
...
\tertiaryStart{\classNameD{Exemplar}{ExemplarAdapterService}}
The \classNameX{Exemplar}{ExemplarAdapterService} class is a subclass of
\classNameR{Common}{BaseAdapterService} and is used to provide communication between
standard \yarp{} ports and an instance of the \classNameR{Exemplar}{ExemplarService}
class, using an instance of the \classNameR{Exemplar}{ExemplarClient} class.
\tertiaryEnd{\classNameE{Exemplar}{ExemplarAdapterService}}
...
The procedures are different for \mac{} and \win{}, although they start from the same
source files. 
\begin{center}\textbf{On~\mac:}\end{center}
\begin{itemize}
