...
For \osx, all the elements of \mplusm{} are placed in the directories \asCode{/opt/m+m}
and \asCode{/Applications}.
For \win, all the elements are placed in the directory
\asCode{C:\textbackslash{}Program Files\textbackslash{}m+m}.\\
