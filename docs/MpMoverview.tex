...
\mplusm{} is available as a standalone installer for \osx{} or \win{}, or it can be built
from source; for \linux{}, \mplusm{} (currently) must be built from source.\\

\mplusm{} requires \osx{} 10.7 or later, \win{} 10 or Ubuntu \linux{} 15.x or later, on a
